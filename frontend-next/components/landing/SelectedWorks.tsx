...
const projects = [
  {
    ...
    gradient:
      "from-violet-500 via-fuchsia-400/60 via-indigo-500/60 to-transparent",
    description:
      "Intelligent day-by-day trip planning with real-time maps and coordinates.",
  },
  {
    ...
    description:
      "Discover hidden gems and iconic landmarks powered by AI curation.",
  },
  {
    ...
    gradient:
      "from-emerald-500 via-emerald-300/60 via-teal-500/60 to-transparent",
    description:
      "Personalized trip recommendations based on your travel style.",
  },
  {
    ...
    gradient:
      "from-amber-500 via-amber-300/60 via-orange-500/60 to-transparent",
    description:
      "Seamless travel planning with a premium, minimal interface.",
  },
];
      ...
      <div className="max-w-[1200px] mx-auto px-6 md:px-10 lg:px-16">
        ...
        >
          ...
          <div className="flex items-end justify-between">
            <div>
              <h2 className="text-3xl md:text-4xl lg:text-5xl text-lp-text font-medium tracking-tight font-body">
                Featured{" "}
                <span className="italic font-display">capabilities</span>
              </h2>
              <p className="mt-3 text-sm md:text-base text-lp-muted max-w-lg font-body">
                From dream to departure -- AI-powered tools that handle every
        ...
        >
          {projects.map((project, i) => (
            <motion.div
              ...
              style={{
                aspectRatio: i === 1 || i === 2 ? undefined : "4/3",
              }}
            >
              {/* Background Image */}
              <Image
              ...
              <div
                className={`absolute bottom-0 left-0 right-0 h-1/2 bg-gradient-to-t ${project.gradient} opacity-40`}
              />
              <div className="absolute bottom-4 left-5 right-5 z-10">
                <h3 className="text-lg md:text-xl font-medium text-white mb-1 font-body">
                  {project.title}
                </h3>
