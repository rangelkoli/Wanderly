      ...
      <div className="max-w-[1200px] mx-auto px-6 md:px-10 lg:px-16">
          ...
          <div className="flex items-end justify-between">
            <div>
              <h2 className="text-3xl md:text-4xl lg:text-5xl text-lp-text font-medium tracking-tight font-body">
                Recent{" "}
                <span className="italic font-display">thoughts</span>
              </h2>
        ...
        <div className="flex flex-col gap-4">
          {journalEntries.map((entry, i) => (
            ...
            >
              {/* Circular image */}
              <div className="relative w-16 h-16 sm:w-[72px] sm:h-[72px] flex-shrink-0 rounded-full overflow-hidden border border-lp-stroke group-hover:border-lp-muted transition-all">
                <Image
                  src={entry.image}
                  alt={entry.title}
                  fill
              ...
              {/* Title */}
              <h3 className="text-base sm:text-lg md:text-2xl font-medium text-lp-text transition-transform group-hover:translate-x-1 flex-shrink-0 font-body">
                {entry.title}
              </h3>
              ...
              {/* Meta */}
              <div className="flex items-center gap-3 text-sm text-lp-muted flex-shrink-0 font-body">
