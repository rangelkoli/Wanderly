...
import QuestionCard, { type AskHumanAnswersPayload, type AskHumanQuestion } from "@/components/human-tool-call";
import PlaceSelectionCard, { type PlaceSelectionPayload, type PlaceOption } from "@/components/place-selection-card";
...
export function Chat({ onSessionCreated }: ChatProps) {
  ...
  const { create: createSession, update: updateSessionMut } = useSessionMutations();
  ...
  const stream = useStream({
    ...
    onThreadId: (newThreadId) => {
      ...
      if (!hasCreatedSessionRef.current && newThreadId && !urlSessionId) {
        ...
        void createSession(newThreadId, "New Chat").then((newSessionId) => {
