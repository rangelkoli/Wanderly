...
const explorations = [
  { id: 1, title: "Celestial Planets", category: "3D Visualization", image: "/explorations/planet.svg" },
  { id: 2, title: "ASCII Art Study", category: "Generative Art", image: "/explorations/ascii.svg" },
  { id: 3, title: "Atmospheric Smoke", category: "Visual Effects", image: "/explorations/smoke.svg" },
  { id: 4, title: "Abstract Cylinder", category: "3D Rendering", image: "/explorations/cylinder.svg" },
  { id: 5, title: "Organic Waves", category: "Motion Design", image: "/explorations/wave.svg" },
  { id: 6, title: "Geometric Cubes", category: "3D Composition", image: "/explorations/cubes.svg" },
];
...
export default function Explorations() {
  ...
  return (
    <section id="explorations" ref={sectionRef} className="relative min-h-[300vh] bg-lp-bg">
      {/* Layer 1: Pinned center content */}
      <div ref={contentRef} className="relative z-10 h-screen flex flex-col items-center justify-center text-center px-4">
        ...
        <h2 className="text-3xl md:text-5xl lg:text-6xl text-lp-text font-medium tracking-tight mb-4" style={{ fontFamily: "var(--font-body)" }}>
          Visual{" "}
          <span className="italic" style={{ fontFamily: "var(--font-display)" }}>
            playground
          </span>
        </h2>
        <p className="text-sm md:text-base text-lp-muted max-w-md mb-8" style={{ fontFamily: "var(--font-body)" }}>
          A space for creative experiments, motion studies, and visual explorations of travel destinations.
        </p>
        <a
    ...
    >
      ...
      <div className="relative w-full h-full rounded-3xl overflow-hidden border border-lp-stroke bg-lp-surface">
        ...
        <div className="absolute inset-0 bg-lp-bg/70 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col items-center justify-center">
          <h4 className="text-lp-text text-base font-medium mb-1" style={{ fontFamily: "var(--font-body)" }}>
            {item.title}
          </h4>
          <p className="text-lp-muted text-xs" style={{ fontFamily: "var(--font-body)" }}>
            {item.category}
          </p>
        </div>
      </div>
