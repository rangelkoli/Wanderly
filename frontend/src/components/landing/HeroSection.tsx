...
export default function HeroSection() {
  ...
  return (
    <section id="hero" className="relative h-screen w-full overflow-hidden">
        ...
        <div className="inline-flex items-center rounded-full backdrop-blur-md border border-white/10 bg-lp-surface px-2 py-2">
          ...
          >
            ...
            <div className="relative flex h-[30px] w-[30px] items-center justify-center rounded-full bg-lp-bg">
              <span className="italic text-[13px] text-lp-text" style={{ fontFamily: "var(--font-display)" }}>
                W
              </span>
            </div>
          </button>
      ...
      >
        {/* Eyebrow */}
        <span className="blur-in text-xs text-lp-muted uppercase tracking-[0.3em] mb-8" style={{ fontFamily: "var(--font-body)" }}>
          AI-POWERED TRAVEL '26
        </span>

        {/* Title */}
        <h1
          className="name-reveal text-6xl md:text-8xl lg:text-9xl italic leading-[0.9] tracking-tight text-lp-text mb-6"
        ...
        {/* Role line */}
        <p className="blur-in text-base md:text-lg text-lp-muted mb-4" style={{ fontFamily: "var(--font-body)" }}>
          Dream it. Describe it.{" "}
          <span
            key={roleIndex}
            className="italic text-lp-text animate-role-fade-in inline-block"
            style={{ fontFamily: "var(--font-display)" }}
          >
            {ROLES[roleIndex]}
          </span>{" "}
        ...
        {/* Description */}
        <p className="blur-in text-sm md:text-base text-lp-muted max-w-md mb-12" style={{ fontFamily: "var(--font-body)" }}>
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center z-10">
        <span className="text-xs text-lp-muted uppercase tracking-[0.2em] mb-3" style={{ fontFamily: "var(--font-body)" }}>
          SCROLL
        </span>
