...
export default function LoadingScreen({ onComplete }: LoadingScreenProps) {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex flex-col justify-between" style={{ background: "hsl(0 0% 4%)" }}>
      {/* Top-left label */}
      <motion.div
      ...
      <div className="flex items-center justify-center">
        <AnimatePresence mode="wait">
          <motion.span
            ...
            style={{ fontFamily: "var(--font-display)", color: "hsl(0 0% 96% / 0.8)" }}
          >
            {WORDS[wordIndex]}
          </motion.span>
        </AnimatePresence>
      ...
      <div className="px-8 pb-8">
        ...
        <div className="flex justify-end mb-4">
          <span
            ...
            style={{ fontFamily: "var(--font-display)", color: "hsl(0 0% 96%)" }}
          >
        ...
        {/* Progress bar */}
        <div className="h-[3px] w-full rounded-full" style={{ background: "hsl(0 0% 12% / 0.5)" }}>
          <div
