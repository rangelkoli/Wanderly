...
export default function ContactFooter() {
  ...
  return (
    <section id="contact" className="relative bg-lp-bg pt-16 md:pt-20 pb-8 md:pb-12 overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="overflow-hidden mb-12 md:mb-16">
          <div ref={marqueeRef} className="whitespace-nowrap inline-flex">
            {Array.from({ length: 10 }).map((_, i) => (
              <span
                key={i}
                className="text-5xl md:text-7xl lg:text-8xl text-lp-text/10 mx-2"
        ...
        <div className="max-w-[1200px] mx-auto px-6 md:px-10 lg:px-16 text-center mb-16">
          <motion.p
            ...
            viewport={{ once: true }}
            className="text-sm md:text-base text-lp-muted max-w-md mx-auto mb-8"
            style={{ fontFamily: "var(--font-body)" }}
          >
            Have a trip in mind? Start planning your perfect journey with our AI concierge. It only takes a few seconds.
          </motion.p>
        ...
        <div className="max-w-[1200px] mx-auto px-6 md:px-10 lg:px-16">
          <div className="border-t border-lp-stroke pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-6">
              {SOCIAL_LINKS.map((link) => (
                <a
                  ...
                  className="text-sm text-lp-muted hover:text-lp-text transition-all hover:-translate-y-0.5"
                  style={{ fontFamily: "var(--font-body)" }}
                >
                  {link.label}
                </a>
            ...
            {/* Copyright */}
            <p className="text-xs text-lp-muted" style={{ fontFamily: "var(--font-body)" }}>
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-lp-muted" style={{ fontFamily: "var(--font-body)" }}>
                AI Concierge Online
              </span>
            </div>
          </div>
